...
type FinancialAccountStatus_StorageServices interface {
	...
	Get(accountID [16]byte, versionOffset uint64) (fas FinancialAccountStatus,nv protocol.NumberOfVersion ,err protocol.Error)
...
type (
	...
	FinancialAccountStatus_Service_Register_Response = protocol.NumberOfVersion
...
type (
	...
	FinancialAccountStatus_Service_Count_Response = protocol.NumberOfVersion
...
type (
	...
	FinancialAccountStatus_Service_Get_Response1 = 	FinancialAccountStatus
	FinancialAccountStatus_Service_Get_Response2 =  protocol.NumberOfVersion
...
type (
	...
	FinancialAccountStatus_Service_FilterByStatus_Response1 interface {
		AccountIDs() [][16]byte
	}

	FinancialAccountStatus_Service_FilterByStatus_Response2 = protocol.NumberOfVersion
